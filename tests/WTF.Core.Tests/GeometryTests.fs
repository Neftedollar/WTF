...
let ``snapshotLine is byte-identical to the pre-UoM baseline`` () =
    let w =
        ...
        |> fst
    let expected =
        """{"current":"1","nmaster":1,"ratio":0.5,"gaps":6,"screen":{"x":0,"y":0,"w":1920,"h":1080},"layouts":["bsp","full","grid","tall","wide"],"workspaces":[{"tag":"1","layout":"tall","windows":[2,1],"focused":2},{"tag":"2","layout":"tall","windows":[],"focused":null},{"tag":"3","layout":"tall","windows":[],"focused":null},{"tag":"4","layout":"tall","windows":[],"focused":null},{"tag":"5","layout":"tall","windows":[],"focused":null},{"tag":"6","layout":"tall","windows":[],"focused":null},{"tag":"7","layout":"tall","windows":[],"focused":null},{"tag":"8","layout":"tall","windows":[],"focused":null},{"tag":"9","layout":"tall","windows":[],"focused":null}],"windows":{"1":{"appId":"foot","title":"shell","floating":false},"2":{"appId":"firefox","title":"web","floating":false}},"arrange":[{"id":2,"x":6,"y":6,"w":948,"h":1068},{"id":1,"x":966,"y":6,"w":948,"h":1068}]}"""
